...
describe('calculator functionality', function() {
  ...
  it('should update display with the result of operation', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should handle numerous operations', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should handle large numbers ', function(){
    ...
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('81018001')
  })
