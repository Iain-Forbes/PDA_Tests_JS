...
describe('calculator', function () {
  ...
  it('it can concatenate multiple number button clicks', function(){
    ...
    assert.strictEqual(calculator.runningTotal, 118)
  })

  it('it chain multiple operations together', function(){
    ...
    assert.strictEqual(calculator.runningTotal, 200)
  })
